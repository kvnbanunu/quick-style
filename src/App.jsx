    ...
    <main className="max-w-4xl mx-auto px-6 py-12 space-y-24">
      ...
      <section className="text-center space-y-4 pt-20">
        ...
        <div className="flex gap-4 justify-center pt-4">
          <a href="#projects" className="px-6 py-3 bg-heading text-white rounded hover:opacity-90 transition-opacity">
            My Projects
          </a>
          <a href="#contact" className="px-6 py-3 border border-brand-border bg-surface rounded hover:bg-surface-strong transition-colors">
            Contact Me
          </a>
        </div>
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-8">
        <article className="p-8 bg-surface rounded-xl border bg-red-500" id="about">
          <p className="text-xs uppercase font-bold text-muted mb-2">About Me</p>
      ...
      <section className="space-y-8" id="projects">
        <div className="border-l-4 border-accent pl-4">
          ...
          <h2 className="text-3xl font-bold text-heading">A couple of example builds</h2>
        </div>
      ...
      <section className="p-10 bg-heading rounded-3xl text-white flex flex-col md:flex-row justify-between items-center gap-8" id="contact">
        <div className="text-center md:text-left">
          <p className="text-xs uppercase font-bold text-accent mb-2">Contact</p>
        ...
        <div className="space-y-4 w-full md:w-auto">
          <div className="bg-white/10 p-4 rounded-xl backdrop-blur-sm border border-white/10">
            ...
            <a href="mailto:reece@email.com" className="text-accent hover:underline">developer@email.com</a>
          </div>
          <div className="bg-white/10 p-4 rounded-xl backdrop-blur-sm border border-white/10">
            <p className="text-xs uppercase opacity-50 font-bold">GitHub</p>
            <a href="https://github.com/reece" className="hover:underline">github.com/developer</a>
          </div>
        </div>
      </section>
    </main>
